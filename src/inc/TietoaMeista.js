        ...
        <div className="tietoameista">
            <h3>Tietoa meistä</h3>
                ...
                <p>Idea Visualiin syntyi ammattikorkeakoulukurssin luennolla. Idean 
                    ...
                    perustaa oman yrityksen.</p>

                <p>Modernin taiteen tekijät myyvät usein taidettaan omilla sosiaalisen
                    median tileillään. Osa heistä on myös perustanut oman sivustonsa
                    tai tehnyt tilin erillisille myyntisivuille. Useiden taiteilijoiden 
                    taidetta yhteen tuovia taidekauppoja ei löytynyt, minkä vuoksi 
                    Visual perustettiin. </p>
        </div>
    )
}